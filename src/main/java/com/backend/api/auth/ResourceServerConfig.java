...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers(HttpMethod.GET, "/api/grupal/course/purchase").hasAnyRole("TEACHER", "ADMIN")
				.antMatchers(HttpMethod.GET, "/api/grupal/course/purchase/{id}").hasAnyRole("TEACHER", "ADMIN")
				.antMatchers(HttpMethod.POST, "/api/grupal/course/purchase").hasAnyRole("TEACHER", "ADMIN", "STUDENT")
